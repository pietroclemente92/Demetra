...
public class PrivateUpdateViewProductActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_private_update_view_product);
        ...
        backBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                PrivateUpdateViewProductActivity.super.onBackPressed();
            }
        });
        ...
        simpleList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                Intent intent = new Intent(PrivateUpdateViewProductActivity.this, PrivateUpdateProductActivity.class);
                intent.putExtra("idUsername", idUsername);
                intent.putExtra("category", category.get(i));
                intent.putExtra("fullname", productList.get(i));
